...
public class TlsSigatureUtil {
	final static String privateKey = "-----BEGIN PRIVATE KEY-----\r\n"
			+ "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgRT3Wzhyj1r//v/Xx\r\n"
			+ "wOJuCtRmcK9ySO1lvySrDgVvJLyhRANCAAQZGt1gH5FhKz1sWlgp20uINRA/aofO\r\n"
			+ "rij7Sqf6gsrI2UtaaSzJbjlT9dHdzpHZKoHk73/pbXolh+YWvIwLPPR+\r\n" + "-----END PRIVATE KEY-----";
	...
	public static String genTencentSign(long appId, String mobilePhone) throws IOException {
		GenTLSSignatureResult genTLSSignatureResult = GenTLSSignatureEx(appId, mobilePhone, privateKey);
	 ...
	 *            创建应用后在配置页面上展示的 acctype
	 * @param publicKey
	 *            用于校验 tls 票据的公钥内容，但是需要先将公钥文件转换为 java 原生 api 使用的格式，下面是推荐的命令 openssl
